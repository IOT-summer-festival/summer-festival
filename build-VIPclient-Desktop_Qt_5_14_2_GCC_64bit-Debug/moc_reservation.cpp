...
#include <memory>
#include "../VIPclient/reservation.h"
...
QT_MOC_LITERAL(3, 35, 21), // "on_guide_stateChanged"
QT_MOC_LITERAL(4, 57, 4), // "arg1"
QT_MOC_LITERAL(5, 62, 21) // "on_sleep_stateChanged"

    },
    "reservation\0on_pushButton_clicked\0\0"
    "on_guide_stateChanged\0arg1\0"
    "on_sleep_stateChanged"
};
...
void reservation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_guide_stateChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->on_sleep_stateChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
